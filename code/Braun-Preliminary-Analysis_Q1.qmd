...
Is there a difference in mean BMI between individuals with diabetes or without diabetes?
...
ggplot(diabetes, aes(BMI)) +
  geom_histogram() +
  facet_wrap(~diabetes_diagnosed, ncol=1, scales = "free_y") # creates a histogram of BMI based and separated by no diabetes diagnosis and diabetes diagnosis
```
