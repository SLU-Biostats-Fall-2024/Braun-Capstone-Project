...
The anova table shows that there is a significant difference in at least two categories so we can reject our null hypothesis. 

```{r}
summary(FPG_model)
```

The intercept is healthy category and the summary shows how different each category is from healthy. Obese has a significantly higher mean FPG than healthy, overweight has a significantly higher FPG than healthy, and underweight has a significantly lower FPG than healthy. (p-value << .001)
...
- Obese has a significantly higher mean FPG than healthy (p << .001)
- Overweight has a significantly higher mean FPG than healthy (p << .001)
- Underweight has a significantly lower mean FPG than healthy (p << .001)
- Overweight has a significantly lower mean FPG than obese (p << .001)
- Underweight has a significantly lower mean FPG than obese (p << .001)
- Underweight has a significantly lower mean FPG than overweight (p << .001)
